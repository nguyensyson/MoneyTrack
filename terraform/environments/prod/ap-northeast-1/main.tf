# =============================================================================
# prod / ap-northeast-1 — Root Module (Secondary Region)
#
...
# be populated from the prod/ap-southeast-1 terraform output before applying.
...
module "compute" {
  ...
  # Cross-region inputs from primary region (prod/ap-southeast-1) terraform output
