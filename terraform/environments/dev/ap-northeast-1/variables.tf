# =============================================================================
# dev / ap-northeast-1 — Variable Declarations (Secondary Region)
#
...
# =============================================================================
# Cross-region inputs — populate from dev/ap-southeast-1 terraform output:
#   cd terraform/environments/dev/ap-southeast-1
...
variable "certificate_arn" {
  description = "ACM certificate ARN — sourced from primary region (dev/ap-southeast-1) terraform output"
  type        = string
}

variable "jwt_secret_arn" {
  description = "Secrets Manager ARN of the JWT secret — sourced from primary region (dev/ap-southeast-1) terraform output"
  type        = string
}

variable "alb_logs_bucket_id" {
  description = "S3 bucket ID for ALB access logs — sourced from primary region (dev/ap-southeast-1) terraform output"
  type        = string
}
