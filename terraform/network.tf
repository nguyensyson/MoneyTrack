...
# (shown as "Gateway Endpoint" in the architecture diagram)
...
# (shown as "Interface Endpoint" in the architecture diagram)
...
# Interface Endpoint for S3 (used by ECR to store image layers)
