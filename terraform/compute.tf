# =============================================================================
# ECR — Container Registry (shared across regions, single registry)
# =============================================================================
...
resource "aws_ecs_task_definition" "backend" {
  family                   = "${var.project_name}-${var.environment}-be"
  ...
  container_definitions = jsonencode([
    {
      ...
      # JWT_SECRET injected from Secrets Manager (not plain-text env var)
      secrets = [
        {
          name      = "JWT_SECRET"
  ...
  tags = { Name = "${var.project_name}-${var.environment}-be-task" }
}
...
resource "aws_ecs_service" "backend" {
  name            = "${var.project_name}-${var.environment}-be-service"
  ...
  # Enable ECS Exec for debugging via SSM Session Manager
  ...
  load_balancer {
    target_group_arn = aws_lb_target_group.backend.arn
    container_name   = "${var.project_name}-be"
  ...
  tags = { Name = "${var.project_name}-${var.environment}-be-service" }
