...
- [x] 4. Create compute module at terraform/modules/compute/
...
- [x] 6. Create IAM module at terraform/modules/iam/
...
- [x] 8. Create global-services module at terraform/modules/global-services/
...
- [x] 9. Create dev/ap-southeast-1 environment-region directory (primary)
...
- [x] 10. Create dev/ap-northeast-1 environment-region directory (secondary, no global_services)
